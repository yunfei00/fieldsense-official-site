  ...
  return (
    <div className="relative mx-auto w-full max-w-2xl">
      <div className="relative rounded-card border border-brand-100 bg-white p-4 shadow-card md:p-5">
        <div className="mb-4 grid gap-3 sm:grid-cols-2 md:gap-4">
        ...
        <div className="grid gap-3 md:grid-cols-[1.1fr_0.9fr] md:gap-4">
          <div className="rounded-card border border-line bg-slate-50 p-4">
            ...
            <div className="heatmap-surface relative h-44 overflow-hidden rounded-md border border-white shadow-inner md:h-56">
              <div className="scanner-grid absolute inset-0 opacity-60" />
              <div className="absolute left-6 top-7 h-24 w-28 rounded border border-white/70 bg-white/10 md:left-8 md:top-8 md:h-28 md:w-36" />
              <div className="absolute bottom-6 left-8 h-2 w-28 rounded-full bg-white/80 md:bottom-7 md:left-12 md:w-40" />
              <div className="absolute right-6 top-8 h-20 w-2 rounded-full bg-white/80 md:right-8 md:top-10 md:h-24" />
          ...
          <div className="grid gap-4">
            <div className="rounded-card border border-line bg-white p-4 shadow-sm">
              ...
              <div className="scanner-grid relative h-24 overflow-hidden rounded-md border border-brand-100 bg-brand-50 md:h-28">
            ...
            <div className="rounded-card border border-line bg-white p-4 shadow-sm">
              ...
              <div className="heatmap-surface relative h-24 rounded-md border border-brand-100 md:h-28">
